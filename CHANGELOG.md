...
Please check [0.2.0](https://github.com/lunnik9/slack/releases/tag/v0.2.0)
...
Please check [0.1.0](https://github.com/lunnik9/slack/releases/tag/v0.1.0)

### v0.0.1 - Jul 26, 2015

If you just updated from master and it broke your implementation, please
check [0.0.1](https://github.com/lunnik9/slack/releases/tag/v0.0.1)
